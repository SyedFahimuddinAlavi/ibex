...
int aes_main(void)
{
    ...
    uint8_t i,in[]  = { 0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e, 0x11, 0x73, 0x93, 0x17, 0x2a };
    struct AES_ctx ctx;
...
int main(int argc, char **argv) {
  ...
  aes_main();
  puts("\nHello simple system\n");
  puts("TIMA:: Just add AES code here\n");
  puthex(0xDEADBEEF);
  putchar('\n');
  puthex(0xBAADF00D);
  putchar('\n');
